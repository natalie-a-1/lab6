# Lab 6: Abstractions and Exceptions
...
* `notifyWin()`: The message, "Nice job, {PlayerName}. You win!", should be printed in the console so that the human player knows that the game is over.
